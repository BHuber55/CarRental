 ...
 * 
 * 3. Also need to double check most of the users input to make sure that the user isn't stupid.
 * 
 * 4. 
 * 
 */
...
//			}
	...
	public static Customer login(ArrayList<Customer> customers) {
		...
		for (Customer customer : customers) {
			...
			found = Customer.findUsername(customers, username);

			if(found && customer.getUserName().equals(username)){
				CUSTOMER = customer;
			}
